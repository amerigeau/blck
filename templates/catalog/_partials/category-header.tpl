...
<div id="js-product-list-header">
    {if $listing.pagination.items_shown_from == 1}
        {if !empty($blck_show_category_bg) && !empty($category.image.large.url)}
            <div class="block-category card card-block block-category--bg" style="background-image:url('{$category.image.large.url}');">
